...
//             amount:       Amount::zero(),
//             receive_name: OwnedReceiveName::new_unchecked("supply_chain_tracker.receive".to_string()),
...
//             init_name: OwnedContractName::new_unchecked("init_supply_chain_tracker".to_string()),
