                ...
                <div className="md:flex md:space-x-10 items-center">
                    <div className='p-5 md:p-0 w-full md:w-1/2' data-aos="fade-down"
                        ...
                        <p className='text-gray-500 py-2'>
                            A decentralized application (dApp) built on top of the Concordium blockchain. 
                            This platform is designed to help users order and track the status of their orders in a supply chain.
                        </p>
                    </div>
